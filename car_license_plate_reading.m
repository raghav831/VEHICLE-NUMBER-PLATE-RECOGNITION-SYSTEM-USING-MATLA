...
clear all;
%.................................
f=imread('E:\SEM_3\CSE4019\CSE4019_PROJECT\noplaterecg\numplate.jpg');
...
if ~isempty(r)
    ...
    fid1 = fopen('E:\SEM_3\CSE4019\CSE4019_PROJECT\noplaterecg\carnum.txt', 'wt');
    fprintf(fid1,'%s',carnum);
    fclose(fid1);
    winopen('E:\SEM_3\CSE4019\CSE4019_PROJECT\noplaterecg\carnum.txt')
